...
namespace masodikgyak_jav.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=valami.database.windows.net;Initial Catalog=Student;User ID=snoncsi;Password=Snoncs2004valami");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cim>(entity =>
        {
            entity.HasKey(e => e.CimId).HasName("PK__CIM__8A3BFC161F122EE5");
        });

        modelBuilder.Entity<Rendeles>(entity =>
        {
            entity.HasKey(e => e.RendelesId).HasName("PK__RENDELES__8DBDC2ADBE1CE4C5");
        ...
        {
            entity.HasKey(e => e.TetelId).HasName("PK__RENDELES__18F19F74E29BD96C");
        ...
        {
            entity.HasKey(e => e.TermekId).HasName("PK__TERMEK__05635B29D839F04F");
        ...
        {
            entity.HasKey(e => e.KategoriaId).HasName("PK__TERMEK_K__37D210EC7918917C");
        ...
        {
            entity.HasKey(e => e.UgyfelId).HasName("PK__UGYFEL__BD19A3718BB45041");
